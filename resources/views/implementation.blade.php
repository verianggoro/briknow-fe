                    ...
                    <div class="text-dark p-2">
                        ...
                        <ul class="collapse" id="collapsedirectorat">
                            <div class="row d-flex spacing-filter">
                                <select name="direktorat" id="dir-impl-init" class="form-control text-black select2" data-live-search="true"
                            ...
                            <div class="row d-flex spacing-filter">
                                <select id="divisi-impl-init" class="mr-auto p-2 form-control select2" value="{{old('divisi')}}" name="divisi[]"></select>
                            </div>
                        </ul>
                    </div>
                    <div class="text-dark p-2">
                                ...
                                <div class="p-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            <li onclick="sortingBy('sortInitImpl')" id="sortInitImpl" data-value="init" class="dropdown-item">Sort By</li>
...
<script src="{{asset_app('assets/js/page/implementation-public.js')}}"></script>
</body>
