        ...
        <!-- NAVIGASI -->
            <div class="d-flex bd-highlight mb-3">
                <div class="mr-auto p-2 bd-highlight">
                    <a class="btn btn-light btn-sm" href="{{ route('manageforum_all') }}" role="button">Published</a>
                    <a class="btn btn-light btn-sm active" href="{{ route('manageforum_removed') }}" role="button">Removed</a>
                </div>
...
@push('page-script')
    ...
    <script src="{{asset_app('assets/js/page/manageforum_removed.js')}}"></script>
@endpush